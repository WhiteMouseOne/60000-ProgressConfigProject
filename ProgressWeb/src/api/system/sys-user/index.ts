...
/**
 * 用户接口与数据库 Users.Email 对齐：列表/新增/编辑/个人信息 的请求与响应应包含 email（或后端 PascalCase 的 Email）。
 * ProgressServer 若自建 Users API，请在 DTO 与实体映射中包含邮箱字段；对接 LineMes 时需在对应 DTO/服务中同步。
 */
